...
<body class="header1">
	...
	<img src="css/images/GUM11_CL11043.jpg" alt="pic1" width="200" height="115" ></a>

		<div id="item1" style="height: 100px; width: 600px">

<table class="header" border="1">
		<tr>
		<td style="width: 70px; "><a href="BusListServlet"type="text/html">バス管理</a></td>
		<td style="width: 70px; "><a href="LineListServlet" type="text/html">路線管理</a></td>
		<td style="width: 70px; "><a href="MembersListServlet" type="text/html">会員管理</a></td>
		</tr>
