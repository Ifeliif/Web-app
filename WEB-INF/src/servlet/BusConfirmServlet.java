...
public class BusConfirmServlet extends AbstractServlet{

	private static final long serialVersionUID = 1L;
	private static final Log log = LogFactory.getLog(BusConfirmServlet.class);
	...
	public String execute(HttpServletRequest request, HttpServletResponse respsponse,
		...
		System.out.println("BusConfirmServlet");




		return "/busConfirm.jsp";
	}
