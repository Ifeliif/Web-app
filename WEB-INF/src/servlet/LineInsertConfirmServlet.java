...
public class LineInsertConfirmServlet extends AbstractServlet {
	...
	public String execute(HttpServletRequest req, HttpServletResponse resp,
		...
		log.debug("servlet start");
		    ...
		    System.out.println("LineInsertConfirmServlet");
			...
			req.setAttribute("raw_start_date", start_date_str);
			req.setAttribute("raw_end_date", end_date_str);
	...
	//yyyyMMdd→yyyy-MM-dd
			...
			if(Integer.parseInt(start_date_str2)>12||Integer.parseInt(end_date_str2)>12||Integer.parseInt(start_date_str3)>31||Integer.parseInt(end_date_str3)>31){
				req.setAttribute("oneTimeMessage", "年月日をyyyyMMdd方式で入力してください。");
				return "LineInsertInputServlet";
					}
	...
	//stop_id→stop_name
		...
		return "/WEB-INF/pages/common/LineInsertConfirm.jsp";
