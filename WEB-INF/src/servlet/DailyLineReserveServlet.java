...
public class DailyLineReserveServlet extends AbstractServlet{
...
//		}
		...
		String date_line_bus=request.getParameter("date_line_reserve");


		String reserve_date_str=date_line_bus.substring(0,10);
		String line_id=date_line_bus.substring(10,15);
		String bus_id=date_line_bus.substring(15,21);
		...
		request.setAttribute("reserve_date", Date.valueOf(reserve_date_str));
