...
public class BusDeleteServlet extends AbstractServlet{

	private static final long serialVersionUID = 1L;
	private static final Log log = LogFactory.getLog(BusDeleteServlet.class);
	...
	public String execute(HttpServletRequest request, HttpServletResponse response,
		...
		int a=busDAO.deleteCertain(bus_id);
		System.out.println(a+"件削除しました。");
