...
public class BusListServlet extends AbstractServlet{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response,
		...
		BusesDAO managerDAO=new BusesDAO(con);
		List<BusesDTO> busList=managerDAO.selectAll();
		request.setAttribute("busList", busList);
		System.out.println("BusListOK");
		return "/busList.jsp";
	}
